...
debugMode="${5:-""}"                                                     # Parameter 5: Debug Mode [ verbose (default) | true | false ]
welcomeDialog="${6:-""}"                                               # Parameter 6: Welcome dialog [ userInput (default) | video | messageOnly | false ]
completionActionOption="${7:-""}"                               # Parameter 7: Completion Action [ wait | sleep (with seconds) | Shut Down | Shut Down Attended | Shut Down Confirm | Restart | Restart Attended (default) | Restart Confirm | Log Out | Log Out Attended | Log Out Confirm ]
requiredMinimumBuild="${8:-""}"                                         # Parameter 8: Required Minimum Build [ disabled (default) | 23F ] (i.e., Your organization's required minimum build of macOS to allow users to proceed; use "23F" for macOS 14.5)
outdatedOsAction="${9:-""}"     # Parameter 9: Outdated OS Action [ /System/Library/CoreServices/Software Update.app (default) | jamfselfservice://content?entity=policy&id=117&action=view ] (i.e., Jamf Pro Self Service policy ID for operating system ugprades)
...
emailEnding="@pennmedicine.upenn.edu"

# A sorted, unique, JSON-compatible list of positions
positionList=$( echo "${positionListRaw}" | tr ',' '\n' | sort -f | uniq | sed -e 's/^/\"/' -e 's/$/\",/' -e '$ s/.$//' )

# [SYM-Helper] Branding overrides
brandingBanner="https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/pmacs_banner.png" 
brandingBannerDisplayText="false"
brandingIconLight="https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png"
brandingIconDark="https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png"

# [SYM-Helper] IT Support Variables - Use these if the default text is fine but you want your org's info inserted instead
supportTeamName="PMACS Client Services Group"
supportTeamPhone=""
supportTeamEmail="medhelp@pennmedicine.upenn.edu "
supportTeamChat=""
supportTeamChatHyperlink=" "
supportTeamWebsite="www.med.upenn.edu/pmacs"
supportTeamHelpDesk="helpdesk.pmacs.upenn.edu"
supportTeamHelpDeskHyperlink="[${supportTeamHelpDesk}](https://${supportTeamHelpDesk})"
supportTeamHyperlink="[${supportTeamWebsite}](https://${supportTeamWebsite})"
supportKB=""
supportTeamErrorKB=""
supportTeamHours="Monday through Friday, 8 a.m. to 5 p.m."

# Disable the "Continue" button in the User Input "Welcome" dialog until Dynamic Download Estimates have been complete [ true | false ] (thanks, @Eltord!)
...
configurationOneDescription="Standard workstation configuration"
...
configurationTwoName="BGS"
configurationTwoDescription="Biomedical Graduate Studies deployment"
...
configurationThreeName="SPO Public Conference Room"
configurationThreeDescription="For SPO Conference Room devices"
    ...
    if [[ "${jamfProPolicyTriggerFailure}" == "failed" ]]; then
        ...
        if [[ "${failureDialog}" == "true" ]]; then
            ...
            if [[ -n "${supportTeamName}" ]]; then
                ...
                supportContactMessage+="If you need assistance, please contact **${supportTeamName}**:  \n"
                ...
                if [[ -n "${supportTeamHelpDesk}" ]]; then
                    supportContactMessage+="- **Help Desk**: ${supportTeamHelpDeskHyperlink}\n"
                fi
...
if [[ -n "${supportTeamName}" ]]; then
    ...
    welcomeMessage+="\n\nIf you need assistance, please contact **${supportTeamName}**:  \n"
    ...
    if [[ -n "${supportTeamHelpDesk}" ]]; then
        welcomeMessage+="- **Help Desk**: ${supportTeamHelpDeskHyperlink}\n"
    fi
...
if [ "$prefillComputerName" == "true" ]; then
    computerName=$(hostname -s)
    computerNamePrefill=',"value" : "'${computerName}'"'
fi
if [ "$promptForComputerName" == "true" ]; then compNameJSON='{ "title" : "Computer Name","required" : true,"prompt" : "Computer Name"'${computerNamePrefill}'},'; fi
...
if [ -n "${supportTeamHelpDesk}" ]; then
  helpmessage+="- **Help Desk**: ${supportTeamHelpDeskHyperlink}  \n"
fi
...
--infotext \"$scriptVersion\" \
--titlefont 'shadow=true, size=36, colour=#FFFDF4' \
--messagefont 'size=16, align=center' \
--height '800' \
--position 'centre' \
--blurscreen \
--ontop \
...
function policyJSONConfiguration() {
    ...
    case ${symConfiguration} in
        ...
        "Standard" ) # Standard Configuration )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Bind to PMACS",
                        "subtitle": "",
                        "icon": "https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png",
                    ...
                    },
                    {
                        "listitem": "Kace",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_bf33556fd3fd7f6dc2124c7704ceb7e3b1666743ac057ed85f2f388ddc7811d1",
                        "progresstext": "Installing KACE Agent",
                        "trigger_list": [
                                         {
                                            "trigger": "symKace",
                                            "validation": "/Library/Application Support/Quest/KACE/bin/KACEMenuBar.app"
                                         }
                        ]
                    },
                    {
                        "listitem": "CrowdStrike Falcon Sensor",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_8c481dda0eaa52c3be33fd4de271916459194437b601c73b218de71f53e8543e",
                        "progresstext": "Installing Crowdstrike",
                        "trigger_list": [
                                         {
                                            "trigger": "symCrowdStrike",
                                            "validation": "/Applications/Falcon.app"
                                         }
                        ]
                    },
                    {
                        "listitem": "Adobe Acrobat DC Pro",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9107045f8d166afc7aa45126606ff6645bc39a7fbce4fb4e97a7563f9fb0225",
                        "progresstext": "Installling Adobe Acrobat DC",
                        "trigger_list": [
                                         {
                                            "trigger": "symAdobeAcrobatDC",
                                            "validation": "/Applications/Adobe Acrobat DC/Adobe Acrobat.app"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_09f0fd195e68b12164d9f9ac8f08a66136405b5be01d60c46417e22f72d8b40c",
                        "progresstext": "Installing Google Chrome",
                        "trigger_list": [
                                         {
                                            "trigger": "symGoogleChrome",
                                            "validation": "/Applications/Google Chrome.app"
                                         }
                        ]
                    },
                    {
                        "listitem": "Zoom Client",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_22e0c8b6f7490870c22f645c0768797d6235543874935668809b3165349c0114",
                        "progresstext": "Installing Zoom Client",
                        "trigger_list": [
                                         {
                                            "trigger": "symZoom",
                    ...
                    },
                    {
                        ...
                        "progresstext": "Installing Ivanti Secure Access",
                        "trigger_list": [
                                         {
                                            "trigger": "symIvantiSecureAccess",
                                            "validation": "/Applications/Ivanti Secure Access.app"
                                         }
                        ]
                    },
                    {
                        "listitem": "Microsoft 365 Business Pro",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_e0e0f913a24bc53efa1d66320a709ae906c82d4b10ccf2f8f5d72f4e245ca25f",
                    ...
                    {
                        "listitem": "Default Desktop Shortcuts",
                        "subtitle": "",
                        "icon": "https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png",
                        "progresstext": "Seting up Default Desktop Shortcuts",
                        "trigger_list": [
                                         {
                    ...
                    },
                    {
                        ...
                        "progresstext": "Enabling FileVault",
                        "trigger_list": [
                                         {
                                            "trigger": "filevault",
                                            "validation": "Local"
                    ...
                    {
                        "listitem": "New User Account Creation",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_8d86095527d5f9b994aa6bcfbcbab07c02fd18f3ab21b57ef9b3bc53c7584153",
                        "progresstext": "Creating New User Account",
                        "trigger_list": [
                                         {
                                            "trigger": "symNewUser",
                                            "validation": "none"
        ...
        "BGS" ) # BGS Configuration )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9107045f8d166afc7aa45126606ff6645bc39a7fbce4fb4e97a7563f9fb0225",
                        "progresstext": "Installing Adobe Acrobat Pro",
                        "trigger_list": [
                                         {
                                            "trigger": "symAdobeAcrobatDC",
                                            "validation": "/Applications/Adobe Acrobat DC/Adobe Acrobat.app"
            ...
            '
            ;;
 "SPO Public Conference Room" ) # SPO Public Conference Room)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9107045f8d166afc7aa45126606ff6645bc39a7fbce4fb4e97a7563f9fb0225",
                        "progresstext": "Adobe Acrobat is a PDF editing and collaboration tool that allows users to create, edit, and share PDF files",
                        "trigger_list": [
                                         {
                                            "trigger": "symAdobeAcrobatDC",
                                            "validation": "/Applications/Adobe Acrobat DC/Adobe Acrobat.app"
                    ...
                    },
                    {
                        "listitem": "VLC",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_9a8f49497b819bd89291f95ab99b9b10c0890f9f52438734f600ad1d4e897429",
                        "progresstext": "Installing VLC",
                        "trigger_list": [
                                         {
                                            "trigger": "symVLC",
                                            "validation": "/Applications/VLC.app"
                                         }
                        ]
                    },
                    {
                    ...
                    {
                        "listitem": "SPO Public Conference Room Dock Configuration",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9dbaba204cca44170dbb00974c88091cb004665caea6ae2edddc06aa1e1c800",
                        "progresstext": "Setting SPO Public Conference Room Dock Configuration",
                        "trigger_list": [
                                         {
                                            "trigger": "symPresDockConfig",
                                            "validation": "None"
                                         }
                        ]
                    },
 ...
 "Presentation" ) # Catch all )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Bind to PMACS",
                        "subtitle": "Binds to PMACS Domain",
                        "icon": "https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png",
                        "progresstext": "Binding to PMACS Domain",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Kace",
                        "subtitle": "KACE Inventory Management",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_bf33556fd3fd7f6dc2124c7704ceb7e3b1666743ac057ed85f2f388ddc7811d1",
                        "progresstext": "Installing KACE Agent",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Adobe Acrobat DC Pro",
                        "subtitle": "Create, edit and share PDF files",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9107045f8d166afc7aa45126606ff6645bc39a7fbce4fb4e97a7563f9fb0225",
                        "progresstext": "Adobe Acrobat is a PDF editing and collaboration tool that allows users to create, edit, and share PDF files",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Zoom Client",
                        "subtitle": "Zoom is a communications platform that allows users to connect with video, audio, phone, and chat.",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_22e0c8b6f7490870c22f645c0768797d6235543874935668809b3165349c0114",
                        "progresstext": "Installing Zoom Client",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Ivanti Secure Access 22.7r3",
                        "subtitle": "Provides access to PMACS domain remotely",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_4f72997afd6503c70109f1bef77649f08e4c5d63bff17e3fca5b442c57cbbe8e",
                        "progresstext": "Installing Ivanti Secure Access",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Microsoft 365 Business Pro",
                        "subtitle": "Standard business applications such as Outlook, Word, and Excel",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_e0e0f913a24bc53efa1d66320a709ae906c82d4b10ccf2f8f5d72f4e245ca25f",
                        "progresstext": "Installing Microsoft 365 Applications",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Default Desktop Shortcuts",
                        "subtitle": "Shortcuts to PMACS helpdesk and password reset tool",
                        "icon": "https://raw.githubusercontent.com/PSOMJAMF/psom-sym-deployment/refs/heads/main/Images/PennMedLogo.png",
                        "progresstext": "Seting up Default Desktop Shortcuts",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Presentation Dock Configuration",
                        "subtitle": "",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_b9dbaba204cca44170dbb00974c88091cb004665caea6ae2edddc06aa1e1c800",
                        "progresstext": "Setting Presentation Dock Configuration",
                        "trigger_list": [
                                         {
                                            "trigger": "symPresDockConfig",
                                            "validation": "None"
